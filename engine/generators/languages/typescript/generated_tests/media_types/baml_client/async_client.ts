...
class BamlStreamClient {
  ...
  TestMediaArrayInputs(
    ...
    try {
      ...
      return new BamlStream<partial_types.MediaArrayAnalysisResult, types.MediaArrayAnalysisResult>(
        raw,
        (a): partial_types.MediaArrayAnalysisResult => a,
        (a): types.MediaArrayAnalysisResult => a,
        this.ctxManager.cloneContext(),
        this.runtime,
      )
    } catch (error) {
  ...
  TestMediaInput(
    ...
    try {
      ...
      return new BamlStream<partial_types.MediaAnalysisResult, types.MediaAnalysisResult>(
        raw,
        (a): partial_types.MediaAnalysisResult => a,
        (a): types.MediaAnalysisResult => a,
        this.ctxManager.cloneContext(),
        this.runtime,
      )
    } catch (error) {
